        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {/* Button 1: WeChat Article Link - Optional */}
              {publication.wechatLink && (
                <Link 
                  href={publication.wechatLink}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  WeChat Official Article (Chinese)
                </Link>
              )}

              {/* Button 2: View details (Chinese) - Optional */}
