...
export default function Banner() {
  ...
  const positionStyles = useMemo(() => [
    ...
    { transform: 'translate(120px, -42px)', zIndex: 20, opacity: 0.6 }, // 中间层 - 向上偏移，增加横向间距
    { transform: 'translate(240px, -84px)', zIndex: 10, opacity: 0.3 }, // 底层 - 向上偏移，增加横向间距
    { transform: 'translate(360px, -126px)', zIndex: 5, opacity: 0 },   // 隐藏层 - 向上偏移，增加横向间距
